    ...
    <%-- Main content --%>
			<section class="content container-fluid">
					...
					<div class="container" style="width: 30%; min-width: 900px; background-color: white; font-size: 14px;" >
						...
						<form id="user_modifyForm" action="/admin/member/user_delete" method="get">
						
						<div  class="container" style="width: 800px; padding: 10% 5%;">
						
							<h3 class="form-signin-heading" style="text-align: center; color: red">사용자 계정 삭제</h3>
							<br><br><c:out value="" />
							
							<div class="form-group">
								<h4 class="form-signin-heading" style="color: #3c8dbc">* 기본정보</h4>
							</div>
							<br>
							...
							<br>
							<div class="form-group">
								<h4 class="form-signin-heading" style="color: #3c8dbc">* 활동정보</h4>
							</div>
							<br>
						</div>
						...
						<div class="form-group text-center">
							<button type="button" id="btn_submit" class="btn btn-secondary">
								계정삭제 <i class="fa fa-check spaceLeft"></i>
							</button>
