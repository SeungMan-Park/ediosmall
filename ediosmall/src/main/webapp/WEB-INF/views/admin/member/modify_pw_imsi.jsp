    ...
    <%-- Main content --%>
			<section class="content container-fluid">		
					...
					<div class="container" style="width: 30%; min-width: 900px; background-color: white; font-size: 14px;" >
						...
						<form id="modify_pw_imsi" action="/admin/member/modify_pw_imsi" method="post">
...
<script>
	...
	$(document).ready(function(){
		...
		$("#btn_submit_mpw").on("click", function(){
	        ...
	        console.log("admin_pw_check : " + admin_pw_check);
	        
	        //return;
	        
	        $.ajax({
				url: "/admin/member/modify_pw_imsi",
				type: "post",
				datatype: "text",
				data: {admin_id : admin_id, admin_pw : admin_pw},
