						...
						<div class="box box-primary">
							...
							<form id="registerForm" role="form" action="/admin/product/insert" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="form-group">
										...
										<select class="form-control" id="mainCategory" name="cat_code" style="width:30%; margin-right:10px; display: inline-block;" >
										  ...
										  <c:forEach items="${categoryList }" var="cate">
										  	<option value="<c:out value="${cate.cat_code }" />"><c:out value="${cate.cat_name }" /></option>
										  </c:forEach>
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Product Name</label> <input
											type="text" id="pdtei_name" name="pdtei_name" class="form-control"
											placeholder="Enter Product name">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">Company</label> <input
											type="text" id="pdtei_producer" name="pdtei_producer" class="form-control"
									...
									<div class="form-group">
										...
										<input style="width:40%; margin-right:10px; display: inline-block;"
											type="text" id="pdtei_price" name="pdtei_price" class="form-control" 
											placeholder="Enter price" />
										<input style="width:40%; display: inline-block;"
											type="text" id="pdtei_discount" name="pdtei_discount" class="form-control "
											placeholder="Enter discounted price" />
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Detail</label>
										<textarea class="form-control" id="pdtei_detail" name="pdtei_detail" rows="8"
									...
									<div class="form-group">
										...
										<input style="width:30%; margin-right:10px; display: inline-block;"
											type="text" id="pdtei_amount" name='pdtei_amount' class="form-control" 
								...
								<div class="box-footer">
									...
									<button id="btn_submit_insert" type="button" class="btn btn-primary">Submit</button>
