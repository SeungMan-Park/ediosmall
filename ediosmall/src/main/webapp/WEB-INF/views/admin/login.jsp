				...
				<div class="container" style="width: 70%; min-width: 900px; background-color: white; font-size: 14px;" >
					<form id="modifyForm" action="/admin/modify" method="post">
						<div class="container" style="width: 800px; padding: 10% 5%;">
							<h2 class="form-signin-heading">계정수정</h2>
							<br><br>
							<div class="form-group">
								<label for="InputEmail">* 아이디</label><br /> <input type="text" class="form-control" id="admin_id" name="admin_id" value='<c:out value="${vo.admin_id}"/>'
								placeholder="아이디를 입력해 주세요" readonly	style="max-width:540px; width:calc(100% - 100px); margin-right: 5px; display: inline-block;">	
							</div>
							<div class="form-group">
								<label for="inputPassword">* 비밀번호</label> <input type="password"
									class="form-control" id="admin_pw" name="admin_pw" value='<c:out value="${vo.admin_pw}"/>'
