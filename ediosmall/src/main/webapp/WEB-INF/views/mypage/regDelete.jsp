...
<%@ include file="/WEB-INF/views/common/category_list_try.jsp" %>
	...
	<section class="content container-fluid">
					...
					<br>
					<%@include file="/WEB-INF/views/common/mypagelist6.jsp" %>
					
					<form id="deleteForm" action="/member/delete" method="get">
					
					<div  class="container"  style="width: 800px; padding: 10% 5%;">
					
							<h4 class="form-signin-heading" style="text-align: center;">계정 탈퇴</h4>
							<br><br><c:out value="" />
							...
							<br>
							<p>비밀번호를 입력하면 계정탈퇴가 가능합니다.</p>
							<p style="color: red;">다만, 탈퇴시 구매내역 등이 소멸되며, 동일한 아이디로 재가입이 제한될 수 있습니다.</p>
