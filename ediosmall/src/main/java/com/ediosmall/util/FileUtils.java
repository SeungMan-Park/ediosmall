...
public class FileUtils {
	...
	public static String uploadFile(String uploadPath, String originName, MultipartFile multipartFile) throws Exception{
		...
		String savedName = uuid.toString() + "_" + originName;  // 고유한 파일생성
	...
	// 날짜 포멧의 폴더명 생성기능. uploadFolder -> "D:\\dev\\upload"
	...
	*/
	...
	private static String makeThumbNail(String uploadPath, String savedPath, String uploadFileName, MultipartFile multipartFile) throws Exception {
		...
		String thumNailName = uploadPath + savedPath + File.separator + "s_" + uploadFileName;
		
		// 1)uploadPath->"D:\\upload\\tmp" + "2021\\03\\31" 2)uploadFileName->"s_" + "sdfsfsaf234sfsfsdr239d_abc.psd"
		FileOutputStream thumbnail = new FileOutputStream(new File(thumNailName));
	...
	public static void deleteFile(String uploadPath, String fileName) {
		...
		// 2021/04/12/s_cd2e05af-c81a-481b-a15f-c07309b2013f_마야.jpeg
		
		//  날짜경로+ UUID_fileName
		String front = fileName.substring(0, 11); 	// 날짜 경로           2021/04/12/
		String end = fileName.substring(13); 		// UUID_fileName    cd2e05af-c81a-481b-a15f-c07309b2013f_마야
		String origin = front + end;    // 2021/04/12/cd2e05af-c81a-481b-a15f-c07309b2013f_마야    => s_ 를 삭제한다
